...
?>
      <div class="table-responsive">
        <table class="table table-striped">
          <thead><tr><th>UID</th><th>用户名</th><th>权限</th><th>操作</th></tr></thead>
          <tbody>
          <?php
...
echo '<tr><td>'.$res['uid'].'</td><td>'.$res['user'].'</td><td>'.$q.'</td><td><a href="./useredit.php?my=edit&uid='.$res['uid'].'" class="btn btn-xs btn-info">编辑</a> <a href="./useredit.php?my=del&uid='.$res['uid'].'" class="btn btn-xs btn-danger" onclick="return confirm(\'你确实要删除此用户吗？\');">删除</a></td></tr>';
}
?>
          </tbody>
        </table>

...
mysqli_query($this->link,"set names 'utf8'");
	...
	class DB {
		...
		// $mysqli = new mysqli('122.114.110.171:3306','db_admin','123456','sy_521sun_cn');
		// if($mysqli -> connect_errno){
		// 	die("数据库连接失败".$mysqli -> connect_error);
		// }
		// echo '<h1 style="color:#f00">数据库连接成功11</h1>';
		//

		//$this->link = @mysql_connect($db_host.':'.$db_port, $db_user, $db_pass);
		$this->link = new mysqli('122.114.110.171:3306','db_admin','123456','sy_521sun_cn');
